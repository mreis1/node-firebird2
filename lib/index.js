...
(function(){
	...
	function Transaction(originalTx) {
		...
		this.query = function(query, params) {
			return new Promise((resolve, reject) => {
				originalTx.query(query, params, (err, result) => {
		...
		this.execute = function(query, params) {
			return new Promise((resolve, reject) => {
				originalTx.execute(query, params, (err, result) => {
					return err ? reject(err) : resolve(result);
				});
			})
		}
		...
		this.rollbackRetaining = function(options) {
			return new Promise((resolve, reject) => {
				originalTx.rollbackRetaining((err) => {
					if (options && options.resolveError) {
						err ? resolve({err: err}) : resolve({err: null})
					}
					else {
		...
		this.commitRetaining = function () {
			return new Promise((resolve, reject) => {
				originalTx.commitRetaining((err) => {
					err ? reject(err) : resolve()
				})
			})
		}
	...
	function Db(originalDb) {
		...
		this.query = function(sql, params) {
			return new Promise((resolve, reject) => {
				originalDb.query(sql, params, function (err, result) {
		...
		this.execute = function(sql, params) {
			return new Promise((resolve, reject) => {
				originalDb.execute(sql, params, function (err, result) {
					err ? reject(err) : resolve(result);
				})
			})
		}
		 ...
		 * @returns {Promise<Fb2.Transaction>}
		 */
		this.transaction = function(isolation) {
			return new Promise((resolve, reject) => {
				originalDb.transaction(isolation, function (err, originalTx) {
					if (err) {
						...
						resolve(new Fb2.Transaction(originalTx))
					}
				})
			})
		}
	...
	Fb2.Db = Db;
	Fb2.attach = function(options) {
		return new Promise((resolve, reject) => {
			exports.attach(options, (err, db) => {
				console.log(err, db);
